...
import com.reviakin_package.clean_architecture.presentation.album.AlbumsFragment
import com.reviakin_package.clean_architecture.presentation.detailphoto.PhotoDetailActivity
import com.reviakin_package.clean_architecture.presentation.photo.PhotosFragment
...
class GalleryActivity : AppCompatActivity(), OnGalleryCallback {
    ...
    override fun gotroDetailPageByPhotoId(imageView: ImageView, id: Long) {
